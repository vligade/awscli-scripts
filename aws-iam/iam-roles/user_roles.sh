...
echo -e  Hello,'\n''\n'Please find the attached AWS IAM-User-Roles Report for US-East1 region.'\n''\n' | mail -s “AWS-IAM-USER-ROLES-LIST” -a $AWS_USERS_ROLES -r cloud.infra.us@company_name.com prmalik@company_name.com -c schandrasekaran@company_name.com , abkumar@company_name.com , tcrowder@company_name.com 

#echo | mail -s "IPADDR $FQDN has started after reboot " -r  cloud.infra.us@company_name.com prmalik@company_name.com
